...
Band.create([{name: "Voltron, The", genre: "8-Bit metal Rock", explicit_lyrics: true, venue_id: 1, event_id: 1},{name: "Smurffs, The", genre: "8-Bit Rap", explicit_lyrics: true, venue_id: 2, event_id: 2}])
